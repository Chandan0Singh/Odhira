        ...
        <section className="py-24 border-b border-[#E5E0D8]">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="max-w-2xl mx-auto text-gray-600 text-lg">
              ...
              products, orders, collaborations, or anything else, our team is
              ready to help.
            </p>
          </div>
        </section>
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-600">support@odhira.com</p>
                  </div>
              ...
              <div className="bg-white border border-[#E5E0D8] p-8 md:p-10">
                ...
                <form onSubmit={handleSubmit}  className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`bg-[#4B5A43] hover:bg-[#C5A46D] transition-all duration-300 text-white px-10 py-4 uppercase tracking-widest ${loading ? "cursor-not-allowed" : ""}`}
                  >
